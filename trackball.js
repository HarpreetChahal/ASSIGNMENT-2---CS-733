...
window.onload = function init() {
  ...
  //Slowing down the speed of the cube
  document.getElementById("Button1").onclick = function () {
    angle = 0.005
  }
  //Increasing the speed of the cube
  ...
  //Background color of the canvas is changed
  ...
  document.getElementById("Button9").onclick = function () {
    // gl.clearColor( 0.7, 0.4, 0.1, 0.80 );
    gl.viewport(0, 0, 300, 300);

  }
  //Change cube size to original
  ...
  // {colors=[  vec4( 1.0, 0.0, 0.0, 1.0 ),  // black
  // vec4( 1.0, 0.0, .08, 1.0 ),  // red
  // vec4( 1.0, 1.0, 0.0, 1.0 ),  // yellow
  // vec4( 0.0, 1.0, 0.20, 1.0 ),  // green
  // vec4( 0.0, 0.40, 1.0, 1.0 ),  // blue
